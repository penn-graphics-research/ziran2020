...
#define T double //TODO: must also change a line in solvePhaseNaive in AnisoFractureSimulation.h (VectorXcf vs VectorXcd)
#define dim 3

namespace Python {
double ax = 0, ay = 0, az = 0, bx = 0, by = 0, bz = 0, alpha1 = 0, alpha2 = 0, fiberScale = 0, residual = 0.001, percent = 0.1, eta = 1, E = 200, rho = 2, tau = 1;
bool useRadial = false, useLongitudinal = false, isotropic = false, orthotropic = false, inextensible = false, implicit = false;
} // namespace Python
...
{
    {
        ...
        FLAGS::Register useRadial_flag("--useRadial", "useRadial", Python::useRadial);
        FLAGS::Register useLongitudinal_flag("--useLongitudinal", "useLongitudinal", Python::useLongitudinal);
        FLAGS::Register isotropic_flag("--isotropic", "useIsotropic", Python::isotropic);
        FLAGS::Register orthotropic_flag("--orthotropic", "useOrthotropic", Python::orthotropic);
        FLAGS::Register inextensible_flag("--inextensible", "useInextensible", Python::inextensible);
        FLAGS::Register implicit_flag("--implicit_damage", "implicit", Python::implicit);
