...
#include <MPM/MpmMultivarSystem.h>
...
public:
    ...
    bool mls_mpm;
    bool dump_F_for_meshing;
    static bool disable_restart;
    ...
    int rpic_damping_iteration = 0;
    int pic_damping_iteration = 0;
    MpmMultivarSystem<T, dim> multivar_system;
...
public:
    ...
    // output F for mpmmeshing purpose..
    void writeF(std::string filename);
    ...
    */
    ...
    void dumpOutParticleBoundingBox();
